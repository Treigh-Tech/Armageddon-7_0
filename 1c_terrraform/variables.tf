variable "aws_region" {
  description = "AWS Region for the knights7 fleet to patrol."
  type        = string
  default     = "us-east-1"
}

variable "project_name" {
  description = "Prefix for naming. Students should change from 'knights7' to their own."
  type        = string
  default     = "knights7"
}
...
variable "sns_email_endpoint" {
  ...
  type        = string
  default     = "treigh-tech@gmail.com" # TODO: student supplies
}
